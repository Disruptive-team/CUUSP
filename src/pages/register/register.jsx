    ...
    return (
      <View style='text-align:center'>
        ...
        <View style='display: flex;justify-content: center;'>
          <Text className='iconfont iconiconfontyonghuming'
                style='color: gray;font-size: 50rpx;line-height: 100rpx;'></Text>
        ...
        <View style='display: flex;justify-content: center;margin-left: 47rpx;'>
          ...
          <Text className={this.state.seePwd ? 'iconfont iconchakanmima' : 'iconfont iconbiyan'}
                style='font-size: 21px;line-height: 42px;z-index: 10;margin-top: 10rpx;transform: translateX(-80rpx);width: 50rpx;'
